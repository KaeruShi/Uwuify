...
public class FabricatedOverlay {
    ...
    public static List<String> getOverlayList() {
        return Shell.cmd("cmd overlay list |  grep -E '^....com.android.shell:UwuifyComponent' | sed -E 's/^....com.android.shell:UwuifyComponent//'").exec().getOut();
    }

    public static List<String> getEnabledOverlayList() {
        return Shell.cmd("cmd overlay list |  grep -E '^.x..com.android.shell:UwuifyComponent' | sed -E 's/^.x..com.android.shell:UwuifyComponent//'").exec().getOut();
    }
    ...
    public static void buildOverlay(String target, String name, String type, String resourceName, String val) {
        ...
        Shell.cmd("cmd overlay fabricate --target " + target + " --name UwuifyComponent" + name + " " + target + ":" + type + "/" + resourceName + " " + resourceType + " " + val).exec();
    }

    public static void enableOverlay(String name) {
        Shell.cmd("cmd overlay enable --user current com.android.shell:UwuifyComponent" + name).exec();
    }

    public static void disableOverlay(String name) {
        Shell.cmd("cmd overlay disable --user current com.android.shell:UwuifyComponent" + name).exec();
    }
